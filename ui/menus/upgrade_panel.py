...
class UpgradePanel:
    ...
    def _generate_options(self):
        ...
        # 2. 武器池 (确保 player.engine 已正确连接)
        weapon_cands = self.player.engine.weapon_manager.get_upgrade_candidates()
    ...
    def apply_upgrade(self, opt):
        ...
        if opt['type'] == 'stat':
            ...
            # 武器升级或获取
            self.player.engine.weapon_manager.add_or_upgrade_weapon(raw['id'])
